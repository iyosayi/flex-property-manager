...
// Building2 icon for Landlords
export const Building2Icon = ({ className = "h-4 w-4 mr-2" }: { className?: string }) => (
...
export const ChevronDownIcon = ({ className = "ml-1 h-4 w-4" }: { className?: string }) => (
...
export const InfoIcon = ({ className = "h-4 w-4 mr-2" }: { className?: string }) => (
...
// BookOpen icon for Careers
export const BookOpenIcon = ({ className = "h-4 w-4 mr-2" }: { className?: string }) => (
...
export const MailIcon = ({ className = "h-4 w-4 mr-2" }: { className?: string }) => (
...
export const MenuIcon = ({ className = "h-5 w-5 filter drop-shadow-sm" }: { className?: string }) => (
